...
export const metadata: Metadata = {
  ...
  description: "Transform your business with data-driven marketing strategies. MarketHub delivers creative excellence and measurable results for ambitious companies.",
  keywords: "marketing agency, digital marketing, marketing strategy, brand growth, marketing solutions",
  ...
  openGraph: {
    title: "MarketHub - Strategic Marketing Solutions",
    description: "Transform your business with data-driven marketing strategies and creative excellence.",
    url: "https://markethub.com",
    siteName: "MarketHub",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SzEkxKoNyIbQ4hnQYui6BHsfB/uploaded-1765894568059-2thga30g.jpg",
        alt: "MarketHub - Marketing Strategy"
      }
    ]
  },
  twitter: {
    ...
    title: "MarketHub - Strategic Marketing Solutions",
    description: "Transform your business with data-driven marketing strategies.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SzEkxKoNyIbQ4hnQYui6BHsfB/uploaded-1765894568059-2thga30g.jpg"]
  },
  robots: {
    index: true,
    follow: true
